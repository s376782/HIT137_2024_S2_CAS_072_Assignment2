...
class BioBERTNerProcessor:
    def __init__(self):
        ...
        self.__model = pipeline("ner", model="alvaroalon2/biobert_diseases_ner")
    ...
    def __process_chunk(self, chunk):
        ...
        self.__diseases.update([ent[0] for ent in entities if "DISEASE" in ent[1]])
...
diseases_biobert = processor.process(file_path)
